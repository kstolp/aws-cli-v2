...
license=("Apache-2.0")
depends=(python 'python-awscrt=0.25.4' python-certifi python-colorama python-cryptography python-dateutil
...
source=("https://awscli.amazonaws.com/awscli-$pkgver.tar.gz"{,.sig}
        ...
        botocore-2551.patch)
sha256sums=('d9a779fc96920a961da42a7c0b372975d240ff10249e1483ade69f0a873b19c5'
            'SKIP'
